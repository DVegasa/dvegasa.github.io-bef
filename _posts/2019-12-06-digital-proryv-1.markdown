...
Это была наша первая ошибка — мы понадеялись на везение, что нам не достанется самая нелюбима нами тема. Вторая ошибка — мы не работали с картами совсем, поэтому какое-то время мы выбирали каким сервисом 